...
import br.com.phcf.portal.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("br.com.phcf.portal.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("br.com.phcf.portal.config.dbmigrations");
